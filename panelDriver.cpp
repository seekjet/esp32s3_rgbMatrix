...
#define PIN_G2 5
#define PIN_B2 6
#define EXTRA_SPI_DATAPIN_1 7
#define EXTRA_SPI_DATAPIN_2 8
...
#define PANEL_ELECTRICAL_ROW_LENGTH 512
    ...
    struct {
        ...
        struct {
            spi_bus_config_t busConfig = {
                ...
                .data4_io_num = PIN_G2,
                .data5_io_num = PIN_B2,
                .data6_io_num = EXTRA_SPI_DATAPIN_1,
                .data7_io_num = EXTRA_SPI_DATAPIN_2,
                .max_transfer_sz = PANEL_ELECTRICAL_ROW_LENGTH * sizeof(uint8_t),
            ...
            spi_transaction_t transactionPrototype = {
                .length = PANEL_ELECTRICAL_ROW_LENGTH, ///< Total data length, in bits
        ...
        size_t bufferSize = PANEL_NUM_ELECTRICAL_ROWS*BUFFER_NUM_PLANES*PANEL_ELECTRICAL_ROW_LENGTH;
...
void spiTransmitTask(void* params) {
    for(;;)
    {
        if (ulTaskGenericNotifyTake(0, true, portMAX_DELAY)) {
            ...
            trans.length = PANEL_ELECTRICAL_ROW_LENGTH * sizeof(uint8_t); 
